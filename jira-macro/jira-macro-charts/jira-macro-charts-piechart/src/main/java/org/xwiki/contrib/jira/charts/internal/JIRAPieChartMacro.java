...
public class JIRAPieChartMacro extends AbstractMacro<JIRAPieChartMacroParameters>
{
    ...
    @Inject
    private JIRAPieChartDataFetcher dataFetcher;

    @Inject
    private DataSourceToChartJSDataSourceConverter converter;
    ...
    {
        JIRAPieChartDataSource dataSource = this.dataFetcher.fetch(parameters);
        ChartJSPieChartDataSource convert = this.converter.convert(dataSource);
        String json;
        try {
